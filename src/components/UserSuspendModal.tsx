...
export interface UserSuspendModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export const UserSuspendModal: React.FC<UserSuspendModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  user
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-md">
        ...
        <div className="flex items-center justify-between p-6 border-b border-[#E5E7EB]">
          <h3 className="text-lg font-semibold text-black dark:text-white">Suspend User</h3>
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                The user will be temporarily suspended and unable to access the system. You can reactivate them later.
              </p>
            </div>
          </div>
