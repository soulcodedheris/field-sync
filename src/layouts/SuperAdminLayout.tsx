...
export const SuperAdminLayout: React.FC = () => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/superadmin/dashboard', icon: DashboardIcon },
    { name: 'Companies', href: '/superadmin/companies', icon: Building },
    { name: 'User Management', href: '/superadmin/user-management', icon: Users },
    { name: 'Plans & Billing', href: '/superadmin/plans-billing', icon: Wallet },
    { name: 'Audit Logs', href: '/superadmin/audit-logs', icon: ClipboardList },
    { name: 'AI Assistant', href: '/superadmin/ai-assistant', icon: Bot },
    { name: 'Announcements', href: '/superadmin/announcements', icon: Megaphone },
    { name: 'Settings', href: '/superadmin/settings', icon: Settings },
  ];

  const bottomNavigation = [
    { name: 'Help', href: '/superadmin/help', icon: HelpIcon },
        ...
        <div className="hidden md:flex items-center gap-4">
          <div className="relative">
            <div className="bg-white dark:bg-gray-800 border border-[rgba(108,108,108,0.5)] dark:border-gray-600 rounded-[10px] h-10 px-3 flex items-center gap-2">
              <Search className="w-6 h-6 text-[rgba(108,108,108,0.5)]" />
              <input
                type="text"
                placeholder="search...."
                className="bg-transparent border-none outline-none text-lg text-[rgba(108,108,108,0.5)] placeholder-[rgba(108,108,108,0.5)]"
              />
            </div>
          </div>
              ...
              >
                ...
                <span 
                  className={`font-medium transition-colors duration-200 ${
                    active ? 'text-[#10BF0A]' : 'text-gray-700 dark:text-gray-300'
                  }`}
                >
                  {item.name}
                </span>
          ...
          {bottomNavigation.map((item) => {
            ...
            return (
              <Link
                ...
                to={item.href}
                onClick={toggleMobileMenu}
                className="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-200 hover:bg-gray-50/80 dark:hover:bg-gray-800/80"
              >
